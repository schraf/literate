...
The following code should be included at the top of every code generated file.
It will include a comment block warning the reader that this file should not be
editted since it code generated. We will also include a copyright signature.
